...
# fix-dashboard-asignaciones.ps1
# El dashboard no mostraba Adrian y Mihail en Añarbe el miercoles
# porque el fetch de asignaciones no tenia limit explicito:
# Supabase devuelve max 1000 filas por defecto, y con 1045 asignaciones
# las mas recientes (incluyendo Añarbe del miercoles) no llegaban.
...
Write-Host "" ; Write-Host "==> Escribiendo dashboard/page.tsx" -ForegroundColor Cyan
...
$ok = Select-String -Path "src\app\dashboard\page.tsx" -Pattern "limit.10000." -Quiet
if ($ok) { Write-Host "    OK: limit 10000 en asignaciones del dashboard" -ForegroundColor Green }
else { Write-Host "    ERROR" -ForegroundColor Red }
Write-Host ""
Write-Host '  git add src\app\dashboard\page.tsx'
Write-Host '  git commit -m "fix: dashboard asignaciones limit 10000"'
Write-Host '  git push'
