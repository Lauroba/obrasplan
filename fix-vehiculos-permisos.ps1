...
# fix-vehiculos-permisos.ps1
# Vehiculos: los botones crear/editar/eliminar ahora usan canDo()
# en vez de isAdmin hardcodeado. El rol Oficina (o cualquier otro
# con permisos en maestros_vehiculos) puede crear, editar y eliminar.
...
Write-Host "" ; Write-Host "==> Escribiendo maestros/vehiculos/page.tsx" -ForegroundColor Cyan

$dst = "src\app\maestros\vehiculos\page.tsx"
$content = @'
"use client";
...
$ok = Select-String -Path "src\app\maestros\vehiculos\page.tsx" -Pattern "puedeCrear" -Quiet
if ($ok) { Write-Host "    OK: permisos granulares en vehiculos" -ForegroundColor Green }
else { Write-Host "    ERROR" -ForegroundColor Red }
Write-Host ""
Write-Host '  git add src\app\maestros\vehiculos\page.tsx'
Write-Host '  git commit -m "fix: vehiculos respeta permisos granulares por rol (canDo)"'
Write-Host '  git push'
