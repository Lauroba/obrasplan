...
# fix-planificador-definitivo.ps1
# Fix definitivo del planificador:
# 1. El fetch de asignaciones filtra por rango de fechas visible
#    (4 semanas atras + 8 adelante) en vez de un limite numerico.
# IMPORTANTE: ejecutar PRIMERO fix_rls_y_paginacion.sql en Supabase
# con Role: postgres
...
Write-Host "    OK: filtro por rango de fechas" -ForegroundColor Green
Write-Host ""
Write-Host '  git add src\app\planificacion\page.tsx'
Write-Host '  git commit -m "fix: planificador filtra asignaciones por rango de fechas visible"'
Write-Host '  git push'
