...
# fix-logs-usuarios-dedup.ps1
# Deduplica usuarios por nombre en el filtro de logs.
# Causa: hay filas duplicadas en public.users de la migracion anterior.
...
Write-Host "    OK: usuarios deduplicados" -ForegroundColor Green
Write-Host ""
Write-Host '  git add src\app\logs\page.tsx'
Write-Host '  git commit -m "fix: logs usuarios deduplicados por nombre"'
Write-Host '  git push'
